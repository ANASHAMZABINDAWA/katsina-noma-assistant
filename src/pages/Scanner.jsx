    ...
    <div className="max-w-md mx-auto p-4 pt-6">
      ...
      <div className="flex gap-3 mt-6">
        <button
          ...
          disabled={loading}
          className="flex-1 bg-gradient-to-r from-emerald-600 to-green-700 text-white py-5 rounded-3xl text-xl font-semibold flex items-center justify-center gap-3 shadow-lg active:scale-95 transition disabled:opacity-70"
        >
          {loading ? "Identifying Plant..." : <><Camera className="w-7 h-7" /> Scan Leaf Now</>}
        </button>
